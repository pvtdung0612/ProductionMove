...
import { updateAccount } from "../../../api/manager";
...
class DialogEdit extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      account: {
        ...
        roleKey: this.props.account.roleKey,
        workplaceID: this.props.account.workplaceID,
      },
      touched: {
        username: false,
        password: false,
  ...
  handleSubmitForm = async (e) => {
    ...
    this.timerID = null;
    await updateAccount(this.state.account).then((res) => {
      ...
      <div>
        <Dialog open={this.props.open}>
          ...
          <DialogContent>
            ...
            >
              <TextField
                ...
                type="text"
                disabled
                defaultValue={this.state.account.id}
                variant="outlined"
                fullWidth
              ></TextField>
              <TextField
              ...
              <TextField
                ...
                onBlur={() => this.handleBlur("workplaceID")}
                onChange={(event) =>
          ...
          <DialogActions>
            ...
            <Button color="primary" type="submit" form="form-edit-account">
              Submit
            </Button>
          </DialogActions>
        </Dialog>
